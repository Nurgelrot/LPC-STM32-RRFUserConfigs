...
M92 X80.00 Y80.00 Z800.00 E690.00                    ; set steps per mm (orbiter2 extruder)
...
; Z-Probe
M558 P8 C"probe" H5 F600:120 T6000                       ; set Z probe type to unmodulated and the dive height + speeds
G31 P500 X-28 Y-12 Z2.5                                  ; set Z probe trigger value, offset and trigger height
M557 X35:180 Y15:180 S20                             ; define mesh grid
...
M143 H0 S120                                         ; set temperature limit for heater 0 to 120C
M308 S1 P"e0temp" Y"thermistor" R2200 T100000 B4092  ; configure sensor 1 as thermistor on pin e0temp
...
M106 P2 S0 H0 T45                                    ; set fan 2 value. Thermostatic control is turned on

; Tools
M563 P0 S"MosquitoHF" D0 H1 F0                       ; define tool 0
